 ...
 *
 * <p>실 검색 로직은 {@code SearchService} 에 있음. 이 테스트는 wrap 의 책임만:
 * 위임, 어댑터 변환, 빈 입력 처리, 1-based index.
 */
class SearchExecutorTest {
    ...
    private ImageResult newImageResult(
            Long id, String url, String photographerName,
            Float score, String technique, String subject, String mood
    ) {
    ...
    void searchAndAdapt() {
        ...
        ImageResult r1 = newImageResult(
                1L, "https://example.com/1.jpg", "Alice",
                0.95f, "watercolor", "landscape", "calm"
        );
        ImageResult r2 = newImageResult(
                2L, "https://example.com/2.jpg", "Bob",
                0.92f, "watercolor", "mountain", null   // mood null 케이스
        );
        ...
        StepContext result = sut.execute(
                newCtxWithKeywords(List.of("watercolor", "landscape"))
        );
        ...
        assertThat(refs.get(0).score())
                .isEqualByComparingTo(BigDecimal.valueOf(0.95f));
    ...
    void tagsIncludeUtilityAndFreeTags() {
        ...
        ImageResult r = new ImageResult(
                1L, "src-1", "https://example.com/1.jpg",
                "user-1", "Alice", 0.9f,
