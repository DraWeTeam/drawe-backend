...
class KomoranKeywordExtractorTest {
    ...
    void analyzesBasicNoun() {
        ...
        assertThat(tokens)
                .anyMatch(t -> "수채화".equals(t.getMorph()) && NOUN_TAGS.contains(t.getPos()));
    }
    ...
    void userDicProtectsLoanword() {
        ...
        assertThat(tokens)
                .anyMatch(t -> "레퍼런스".equals(t.getMorph()) && NOUN_TAGS.contains(t.getPos()));
    }
    ...
    void userDicProtectsGrim() {
        ...
        assertThat(tokens)
                .anyMatch(t -> "그림".equals(t.getMorph()) && NOUN_TAGS.contains(t.getPos()));
    }
    ...
    void noFallbackWhenAllHits() {
        ...
        assertThat(keywords)
                .containsExactlyInAnyOrder("watercolor", "landscape", "light and shadow");
        assertThat(fallback.calls).isEmpty();
    }
