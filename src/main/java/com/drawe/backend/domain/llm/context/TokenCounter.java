 ...
 * JTokkit 기반 토큰 카운터.
 *
 * <p>S2' Phase 6 Layer 1. GPT-4 인코딩 (cl100k_base) 사용 — Claude·Grok 도 비슷한 BPE
 * 토크나이저를 쓰므로 정확하지는 않아도 운영 모니터링·예산 통제에 충분.
 *
 * <p>한국어는 영어보다 토큰 효율이 낮은 편이지만 (한 글자 ~2-3 토큰), 동일 인코더로 측정하면
 * 상대 비교는 정확하다.
 */
@Component
