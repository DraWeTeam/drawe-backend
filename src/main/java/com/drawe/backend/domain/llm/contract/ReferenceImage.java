 ...
 * <ul>
 *   <li>의존 차단 목적으로 별도 타입 정의</li>
 *   <li>B의 {@code SearchExecutor} 안에서 {@code ImageResult} → {@code ReferenceImage} 어댑터 변환</li>
 *   <li>변환 시 1-based {@code index} 부여 → 인용 무결성 검사 키</li>
 * </ul>
 *
 * <p>{@code imageId} vs {@code index} 분리:
 * <ul>
 *   <li>{@code index} — 사용자가 [1], [2], [3] 으로 보는 번호.
 *       LLM 응답의 "1번처럼" 인용 매칭에 사용.</li>
 *   <li>{@code imageId} — DB 키. 메트릭·로깅·디버깅용.</li>
 * </ul>
 *
