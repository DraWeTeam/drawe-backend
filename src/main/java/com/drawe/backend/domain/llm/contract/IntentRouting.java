 ...
 * 의도 → step 시퀀스 정적 라우팅.
 *
 * <p>설계 결정: 동적 {@code PlanSpec} 인터프리터 대신 정적 Map 채택. 10개 의도 중 8개가 정적 시퀀스라 런타임 합성 불필요 (외부 리뷰 결론, ADR
 * §3 참조).
 *
 * <p>011~013 ({@code LEARNING_PATH}, {@code FOLLOWUP}, {@code COMPARE}) 는 베타 후 빈도 확인되면 추가.
 *
