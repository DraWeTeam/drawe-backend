 ...
 *
 * <p>Grok 의 {@code draw_guide_response} 스키마({@code message,citations,offer_generate})를 {@link
 * OutputParser} 가 이 DTO 로 옮기고, {@link OutputIntegrityChecker} 가 환각 인용을 제거해 정정본을 다시 이 DTO 로 돌려준다(재호출
 * 없음).
 *
